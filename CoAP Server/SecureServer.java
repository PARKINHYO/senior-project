...
public class SecureServer {
        ...
        public static void main(String[] args) {
                // ExecPyThread execpythread = new ExecPyThread();
                // Thread t = new Thread(execpythread, "센서값 측정코드 실행");
                ...
                server.add(new CoapResource("example1") {
                        ...
                        public void handleGET(CoapExchange exchange) {
                                ...
                                exchange.respond(ResponseCode.CONTENT, latlon);
                                System.out.println("CoapServer : " + latlon);
                        }
                }.intialize());

                server.add(new CoapResource("example2") {
                        private int count;
                        private CoapResource intialize(){
                                setObservable(true);
                                setObserveType(Type.CON);
                ...
                //      server.addEndpoint(new CoAPEndpoint(new DTLSConnector(new InetSocketAddress("0.0.0.0", DTLS_PORT)), NetworkConfig.getStandard()));
                ...
                List<Mode> modes = CredentialsUtil.parse(args,
                                CredentialsUtil.DEFAULT_SERVER_MODES, SUPPORTED_MODES);
